...
import { createPillToggle } from "../lib/mortality/pill-toggle";
import { initSummaryStats } from "../lib/mortality/summary-stats";
import type { Dimensions, Filters, Sex } from "../lib/mortality/types";
...
const CHART_LOADERS: Record<string, () => Promise<ChartModule>> = {
  evolution: () => import("../lib/mortality/charts/evolution"),
  causes: () => import("../lib/mortality/charts/causes"),
  map: () => import("../lib/mortality/charts/map"),
  "age-composition": () => import("../lib/mortality/charts/age-composition"),
  pyramid: () => import("../lib/mortality/charts/pyramid"),
};
...
export async function mountMortalityDashboard(root: ParentNode): Promise<void> {
